...
# Shared with preload-search-tools.sh (SessionStart) so both surfaces resolve
# roots from the same config and state the same base_path.
from hooks.lib.fff_roots import root_hint as fff_root_hint
