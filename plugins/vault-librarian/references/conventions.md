...
These are the rules the `vault-librarian` skill enforces. They reflect what the vault already does in 80%+ of files — the skill exists to push the remaining 20% into line and to keep new material consistent from day one.
